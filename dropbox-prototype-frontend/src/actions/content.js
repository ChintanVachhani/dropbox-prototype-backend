    ...
    axios({ headers: {         "Content-Type": "application/x-www-form-urlencoded"      },
      ...
      .then((result) => {
        ...
        dispatch({
          ...
          response: result.data.data + ' uploaded.',
        });
      }).catch((result) => {
      if (result.response) {
        dispatch({
    ...
    axios({ headers: {         "Content-Type": "application/x-www-form-urlencoded"      },
      ...
      .then((result) => {
        ...
        dispatch({
          ...
          response: result.data.data + ' star toggled.',
        });
      }).catch((result) => {
      if (result.response) {
        dispatch({
    ...
    axios({ headers: {         "Content-Type": "application/x-www-form-urlencoded"      },
      ...
      .then((result) => {
        ...
        dispatch({
          ...
          response: result.data.data + ' deleted.',
        });
      }).catch((result) => {
      if (result.response) {
        dispatch({
    ...
    axios({ headers: {         "Content-Type": "application/x-www-form-urlencoded"      },
      ...
      .then((result) => {
        ...
        dispatch({
          ...
          response: result.data.data + ' created.',
        });
      }).catch((result) => {
      if (result.response) {
        dispatch({
    ...
    axios({ headers: {         "Content-Type": "application/x-www-form-urlencoded"      },
      ...
      .then((result) => {
        ...
        dispatch({
          ...
          response: result.data.data + ' shared.',
        });
      }).catch((result) => {
      if (result.response) {
        dispatch({
